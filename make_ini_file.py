...
def _add_bio(nc, biofile=None):
    ...
    bio_names = ['NO3','NH4','chlorophyll','phytoplankton','zooplankton',
                 ...
                 'LdetritusC','SdetritusC','TIC','alkalinity',
                 'oxygen','PO4','LdetritusP','SdetritusP','COD','H2S']

    bio_out = {}

    if biofile is 0:
        for name in bio_names:
            bio_out[name] = 0.0 #np.ndarray(shape=[Nbed, jmax, imax])
    else:
        pass
...
if __name__ == '__main__':
    ...
    grdfile = 'test/nc/ob500_grd-v5.nc'
    inifile = 'ob500_ini_bio_bgc_2012.nc'
    bgcfile = 'rst{}.csv'
